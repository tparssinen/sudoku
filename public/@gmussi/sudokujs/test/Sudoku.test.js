/* Unit tests for sudokujs */

import { test } from 'node:test';
import { ok, deepEqual, throws, equal } from 'node:assert/strict';
...
test('Solve', () =>{
	...
	const puz_unsolvable = 
        '.........9......84.623...5....6...453...1...6...9...7....1.....4.5..2'+
        '....3.8...99';
	const puz_unsolvable2 = '5168497323.46.2...5.97...65135.6.9.7472591..696837.'+
        '.5.253186.746842.75..791.5.6.8';
	const puz_too_big = 
        '.........9......84.623...5....6...453...1...6...9...7....1.....4.5..2'+
        '....3.8....91';
	const puz_invalid_chars = 
        '.........9......84.623...5....6...453...1...6...9...7....1.....4.5..2'+
        '....3.8..!.9';
	...
	// Board too big
	throws(() =>{sudoku.solve(puz_too_big);}, 'Invalid board size');
    
	// Board has invalid character
	throws(() =>{sudoku.solve(puz_invalid_chars);}, 'Invalid characters');
});

test('Get candidates map', () =>{
	const puz = 
        '4.....8.5.3..........7......2.....6.....8.4......1.......6.3.7.5..2..'+
        '...1.4......';
	const puz_candidates = {
	...
	// Board too big
	throws(() =>{sudoku._get_candidates_map(puz_too_big);}, 
		'Invalid board size');
    
	// Board has invalid character
	throws(() =>{sudoku._get_candidates_map(puz_invalid_chars);}, 
		'Invalid characters');
});
...
test('Get square -> vals map', () =>{
	...
	throws(() =>{sudoku._get_square_vals_map('');}, 
...
test('Get square -> units map', () =>{
	...
	const squares = sudoku._cross(rows, cols);
	const units = sudoku._get_all_units(rows, cols);
	const square_units_map = sudoku._get_square_units_map(squares, units);
...
test('Get square -> peers map', () =>{
	...
	const units = sudoku._get_all_units(rows, cols);
	const square_units_map = sudoku._get_square_units_map(squares, units);
	const square_peers_map = sudoku._get_square_peers_map(squares, 
		square_units_map);
...
test('Get all units', () =>{
	const rows = 'ABCDEFGHI';
	const cols = '123456789';
	const all_units = sudoku._get_all_units(rows, cols);
...
test('Board string -> grid', () =>{
	const board1 = '.5.1972.8.9.2651.7217483596.4.3..7.9.3.7.98...796..32.981536472325974681764812953';
	const board2 = '.1.872.4..47695....651437..4217.8.3..7.2.4...58.9.12746583294171924873..734516...';
	const board3 = '23.94.67.8..3259149..76.32.1.....7925.321.4864..68.5317..1....96598721433...9...7';
...
test('Integration', () =>{
	for(let i = 0; i < 10; ++i){
		...
		const board_grid = sudoku.board_string_to_grid(board);
		const board_string = sudoku.board_grid_to_string(board_grid);
...
// =======
test('Validate board', () =>{
	const report_empty             = sudoku.validate_board();
	const report_invalid_size      = sudoku.validate_board('123');
	const report_invalid_char      = sudoku.validate_board(
		'.3.9564272..784136764231589327149658.4.56..73..637._14412893765.8.627'+
        '341673415892');
	const report_good              = sudoku.validate_board(
